...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        "medical": "0 4px 20px -2px hsl(var(--primary) / 0.15)",
        "medical-lg": "0 8px 30px -4px hsl(var(--primary) / 0.2)",
        "soft": "0 2px 15px -3px rgba(0, 0, 0, 0.08), 0 4px 6px -4px rgba(0, 0, 0, 0.05)",
        "soft-lg": "0 10px 40px -10px rgba(0, 0, 0, 0.1), 0 4px 6px -4px rgba(0, 0, 0, 0.05)",
      },
    },
  },
